...
すべてのテストシナリオ（TS-01 ～ TS-06）が**成功**と判定された場合、Sprint 1の受入基準を満たします。
...
4. **受入検証**: `docs/S1-08_acceptance_validation.md`
   - S1-08テレメトリ実装の検証
...
**このドキュメントを使用して、第三者が Sprint 1 の受入条件を完全に検証できることを確認してください。**
