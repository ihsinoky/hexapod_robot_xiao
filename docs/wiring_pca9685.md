...
|------|----------|-----------|----------|
| SDA  | P0.04    | D4        | 左側上から5番目 |
| SCL  | P0.05    | D5        | 左側上から6番目 |
| GND  | GND      | GND       | 背面パッド |
| 3V3  | 3V3      | 3V3       | 背面パッド |

**ピン配置図**:
```
        XIAO nRF52840 (上から見た図、USB-Cポートが上)
        
 左側                      右側
  1  [D0 /P0.02]     [D10/P1.03]  11
  2  [D1 /P0.03]     [D9 /P0.29]  10
  3  [D2 /P0.28]     [D8 /P1.13]   9
  4  [D3 /P0.29]     [D7 /P1.15]   8
  5  [D4 /P0.04] ← SDA  [D6 /P1.11]   7
  6  [D5 /P0.05] ← SCL  (背面パッド)
  7  [D6 /P1.11]     (背面パッド)
